 ...
 */
public final class CheckPromoteEmailResponse extends OrganizationResponse {
                ...
                if (parser.getName().equals("KeyValuePairOfstringanyType")) {
                    ...
                    do {
                        ...
                        if (parser.getName().equals("key")) {
                            parser.next();
                            if (parser.getText().equals("ShouldPromote")) {
                                parser.nextTag();
                                parser.nextTag();
                                this.shouldPromote = (boolean) Utils.objectFromXml(parser);
                            }
                        }
